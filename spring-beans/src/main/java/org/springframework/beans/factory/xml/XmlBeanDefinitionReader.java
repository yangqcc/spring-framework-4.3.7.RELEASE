...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
    ...
    public int loadBeanDefinitions(EncodedResource encodedResource) throws BeanDefinitionStoreException {
        ...
        try {
            //从encodedResource中获取已经封装的Resource对象并且再次从Resource中获取InputStream
    ...
    /**
     * 通过配置的DocumentLoader加载指定的ducoment
    ...
    /**
     * 注册包含在给定DOM文档中的bean定义,被{@code loadBeanDefinitions}调用
     * <p>
    ...
    /**
     * 创建{@link BeanDefinitionDocumentReader}用来从XML文档读取bean definitions
     * <p>
