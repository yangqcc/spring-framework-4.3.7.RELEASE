...
public class ContextLoader {
    ...
    static {
        //读取配置文件,这里是spring内部文件,所以并不开放给开发者
    ...
    public WebApplicationContext initWebApplicationContext(ServletContext servletContext) {
        ...
        try {
            ...
            if (this.context == null) {
                //初始化context,创建WebApplicationContext实例
    ...
    /**
     * 返回WebApplicationContext的实现类,要么是默认的XmlWebApplicationContext,要么是客户端指定
     * 的context类
    ...
    protected Class<?> determineContextClass(ServletContext servletContext) {
        //CONTEXT_CLASS_PARAM="contextClass",所以在客户端的web.xml中可以配置<context-param>来
        //加载自己想要记载的类,否则加载默认的类
        ...
        if (contextClassName != null) {
            ...
            //加载默认的类,默认类为XmlWebApplicationContext
