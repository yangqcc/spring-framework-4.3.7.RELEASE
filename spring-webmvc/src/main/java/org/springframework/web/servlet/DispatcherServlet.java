...
public class DispatcherServlet extends FrameworkServlet {
    ...
    /**
     * 继承自父类,内部调用了{@link #initStrategies(ApplicationContext)}
    ...
    /**
     * 初始化servlet使用的对象,为了进一步对象实例化,可能被子类覆盖
    ...
    /**
     * 初始化MultipartResolver,该类主要用来处理文件上传,设置multipartResolver
    ...
    private void initHandlerMappings(ApplicationContext context) {
        ...
        //为了保证至少有一个HandlerMapping,没有其他mappings的情况下,注册一个默认的HandlerMapping
    ...
    /**
     * 初始化HandlerAdapters,如果BeanFactory里没有,则创建默认的HandlerAdapters->SimpleControllerHandlerAdapter
    ...
    /**
     * 通过策略接口创建默认的策略类,默认从"DispatcherServlet.properties"文件中获取创建类的类名,
     * 通过BeanFactory实例化对应的类
     * <p>
    ...
    protected void doDispatch(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        //里面封装了Handler,而Handler可能是Controller的子类
